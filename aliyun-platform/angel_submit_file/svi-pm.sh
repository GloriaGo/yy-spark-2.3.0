...
$SPARK_HOME/bin/spark-submit \
    ...
    --conf spark.spark.angel.master.memory=14g \
    ...
    input:"hdfs://bach101:9000/user/root/data/repar_pubmed_libsvm" \
    test:"hdfs://bach101:9000/user/root/data/repar_test_pubmed_libsvm" \
    numIter:301 \
    topicSize:100 \
    miniBatchFraction:0.002 \
    kappa:0.51 \
    tau0:16
