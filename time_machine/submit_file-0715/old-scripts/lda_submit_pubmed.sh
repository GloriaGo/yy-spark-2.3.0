...
../spark-2.4.3-bin-hadoop2.6/bin/spark-submit --master yarn \
	...
	hdfs://master.cluster:9000/user/guoyunyan/repar/repar_pubmed_training \
	hdfs://master.cluster:9000/user/guoyunyan/repar/repar_pubmed_validate \
	hdfs://master.cluster:9000/user/guoyunyan/repar/repar_pubmed_test \
	$optimizer \
	$topic_size \
	$sampling_rate \
	$learning_decay \
