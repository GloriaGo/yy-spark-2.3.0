...
../spark-2.4.3-bin-hadoop2.6/bin/spark-submit --master yarn \
	...
	incBS_RM_nyt200 \
	hdfs://master.cluster:9000/user/guoyunyan/nytimes_spark/repar_nyt_training \
	hdfs://master.cluster:9000/user/guoyunyan/nytimes_spark/repar_nyt_validate \
	hdfs://master.cluster:9000/user/guoyunyan/nytimes_spark/repar_nyt_test \
	$optimizer \
	$topic_size \
	$sampling_rate \
	$learning_decay \
