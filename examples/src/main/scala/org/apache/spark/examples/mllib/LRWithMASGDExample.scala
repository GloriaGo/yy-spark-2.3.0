...
object LRWithMASGDExample extends Logging{
  def main(args: Array[String]): Unit = {
    ...
    val ghandmodel = GhandLogRSGDShuffleModel
    val startTime = System.nanoTime()
    val model = ghandmodel.train(training, numIterations, stepSize, miniBatchFraction, regParam)
